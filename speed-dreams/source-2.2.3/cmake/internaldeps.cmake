...
MACRO(ADD_INTERFACE_INCLUDEDIR)
  ...
  IF(IN_SOURCETREE)
    ...
    SET(UNIT_TEST_UTILITIES_INCLUDE_CANDIDATE ${SOURCE_DIR}/src/simulatedDrivingAssistance/unitTestUtilities)
  ELSE(IN_SOURCETREE)
  ...
  FIND_PATH(FRONTEND_INTERFACE_INCLUDE_DIR IndicatorConfig.h
  ...
  FIND_PATH(UNIT_TEST_UTILITIES_INCLUDE_DIR TestUtils.h
            PATHS ${UNIT_TEST_UTILITIES_INCLUDE_CANDIDATE} /usr/include /usr/local/include NO_DEFAULT_PATH)
  FIND_PATH(UNIT_TEST_UTILITIES_INTERFACE_INCLUDE_DIR TestUtils.h
            PATHS ${UNIT_TEST_UTILITIES_INCLUDE_CANDIDATE} /usr/include /usr/local/include)
  ...
  MARK_AS_ADVANCED(UNIT_TEST_UTILITIES_INTERFACE_INCLUDE_DIR)
  ...
  IF(UNIT_TEST_UTILITIES_INTERFACE_INCLUDE_DIR)
    INCLUDE_DIRECTORIES(${UNIT_TEST_UTILITIES_INTERFACE_INCLUDE_DIR})
  ELSE(UNIT_TEST_UTILITIES_INTERFACE_INCLUDE_DIR)
    MESSAGE(FATAL_ERROR "Cannot find unit test utilities interface header files")
  ENDIF(UNIT_TEST_UTILITIES_INTERFACE_INCLUDE_DIR)
  ...
  FOREACH(SDLIB_LIB ${ARGN})
    ...
    ELSEIF(SDLIB_LIB STREQUAL "frontend")
      ...
      ELSE(IN_SOURCETREE)
        SET(INCLUDE_CANDIDATE ${SD_INCLUDEDIR_ABS})
      ENDIF(IN_SOURCETREE)
      FIND_PATH(SDLIB_FRONTEND_INCLUDE_DIR IndicatorConfig.h PATHS ${INCLUDE_CANDIDATE} /usr/include /usr/local/include NO_DEFAULT_PATH)
      FIND_PATH(SDLIB_FRONTEND_INCLUDE_DIR IndicatorConfig.h PATHS ${INCLUDE_CANDIDATE} /usr/include /usr/local/include)
      MARK_AS_ADVANCED(SDLIB_FRONTEND_INCLUDE_DIR)
      SET(SDLIB_EXTRA_INCLUDEDIR SDLIB_FRONTEND_INCLUDE_DIR)
    ELSEIF(SDLIB_LIB STREQUAL "rppUtils")
      IF(IN_SOURCETREE)
        SET(INCLUDE_CANDIDATE ${SOURCE_DIR}/src/simulatedDrivingAssistance/rppUtils)
      ELSE(IN_SOURCETREE)
        SET(INCLUDE_CANDIDATE ${SD_INCLUDEDIR_ABS})
      ENDIF(IN_SOURCETREE)
      FIND_PATH(SDLIB_RPP_UTILS_INCLUDE_DIR RppUtils.hpp PATHS ${INCLUDE_CANDIDATE} /usr/include /usr/local/include NO_DEFAULT_PATH)
      FIND_PATH(SDLIB_RPP_UTILS_INCLUDE_DIR RppUtils.hpp PATHS ${INCLUDE_CANDIDATE} /usr/include /usr/local/include)
      MARK_AS_ADVANCED(SDLIB_RPP_UTILS_INCLUDE_DIR)
      SET(SDLIB_EXTRA_INCLUDEDIR SDLIB_RPP_UTILS_INCLUDE_DIR)
    ELSEIF(SDLIB_LIB STREQUAL "unitTestUtilities")
      IF(IN_SOURCETREE)
        SET(INCLUDE_CANDIDATE ${SOURCE_DIR}/src/simulatedDrivingAssistance/unitTestUtilities)
      ELSE(IN_SOURCETREE)
        SET(INCLUDE_CANDIDATE ${SD_INCLUDEDIR_ABS})
      ENDIF(IN_SOURCETREE)
      FIND_PATH(SDLIB_UNIT_TEST_UTILITIES_INCLUDE_DIR TestUtils.h PATHS ${INCLUDE_CANDIDATE} /usr/include /usr/local/include NO_DEFAULT_PATH)
      FIND_PATH(SDLIB_UNIT_TEST_UTILITIES_INCLUDE_DIR TestUtils.h PATHS ${INCLUDE_CANDIDATE} /usr/include /usr/local/include)
      MARK_AS_ADVANCED(SDLIB_UNIT_TEST_UTILITIES_INCLUDE_DIR)
      SET(SDLIB_EXTRA_INCLUDEDIR SDLIB_UNIT_TEST_UTILITIES_INCLUDE_DIR)
    ELSE(SDLIB_LIB STREQUEL "unitTestUtilities")
