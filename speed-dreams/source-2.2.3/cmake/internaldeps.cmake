...
MACRO(ADD_INTERFACE_INCLUDEDIR)
  ...
  FIND_PATH(FRONTEND_INTERFACE_INCLUDE_DIR Recorder.h
  ...
  FOREACH(SDLIB_LIB ${ARGN})
    ...
    ELSEIF(SDLIB_LIB STREQUAL "frontend")
      ...
      ELSE(IN_SOURCETREE)
        SET(INCLUDE_CANDIDATE ${SD_INCLUDEDIR_ABS})
      ENDIF(IN_SOURCETREE)
      FIND_PATH(SDLIB_FRONTEND_INCLUDE_DIR Recorder.h PATHS ${INCLUDE_CANDIDATE} /usr/include /usr/local/include NO_DEFAULT_PATH)
      FIND_PATH(SDLIB_FRONTEND_INCLUDE_DIR Recorder.h PATHS ${INCLUDE_CANDIDATE} /usr/include /usr/local/include)
