...
if(NSIS_FOUND AND NSIS_MAKE_EXE AND NSIS_INET_PLUGIN)
   ...
   IF(NOT EXISTS ${NSIS_INSTALL_DIR})
        MESSAGE(STATUS "BANANEN DOES NOT EXIST")
        FILE(PATH "${CMAKE_BINARY_DIR}/${CMAKE_INSTALL_PREFIX}" NSIS_CHECK_DIR)
        FILE(TO_NATIVE_PATH "${CMAKE_BINARY_DIR}/${CMAKE_INSTALL_PREFIX}" NSIS_INSTALL_DIR)
   ENDIF(NOT EXISTS ${NSIS_INSTALL_DIR})

   IF(NOT EXISTS ${NSIS_INSTALL_DIR})
        MESSAGE(STATUS "NSIS_INSTALL_DIR NOT FOUND")
        MESSAGE(STATUS "SEARCHED FOLDERS:")
        MESSAGE(STATUS "${CMAKE_INSTALL_PREFIX}")
        MESSAGE(STATUS "${CMAKE_BINARY_DIR}/${CMAKE_INSTALL_PREFIX}")
        MESSAGE(FATAL_ERROR "NSIS failed")
   ENDIF(NOT EXISTS ${NSIS_INSTALL_DIR})
