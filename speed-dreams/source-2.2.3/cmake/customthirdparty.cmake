...
#   version     : $Id: customthirdparty.cmake 7184 2020-10-04 18:35:53Z beaglejoe $
#
############################################################################
...
MACRO(SD_INSTALL_CUSTOM_3RDPARTY TARGET_NAME)
	...
	SET(_DLL_PATHNAME ${MYSQL_BIN_DIR}/mysqlcppconn8-2-vs14.dll)
	LIST(APPEND _THIRDPARTY_DLL_PATHNAMES "${_DLL_PATHNAME}")

	SET(_DLL_PATHNAME ${MYSQL_BIN_DIR}/mysqlcppconn-9-vs14.dll)
	LIST(APPEND _THIRDPARTY_DLL_PATHNAMES "${_DLL_PATHNAME}")
