...
MACRO(ADD_MSGPACK_PACKAGE TARGET)
  ...
  INCLUDE_DIRECTORIES(${SDEXT_CUSTOM_3DPARTY_DIR}/include/msgpack) #hard coded for now, needs to change when we switch to linux
ENDMACRO(ADD_MSGPACK_PACKAGE TARGET)

MACRO(ADD_IPCLIB_PACKAGE TARGET)
  TARGET_LINK_LIBRARIES(${TARGET} ${SDEXT_CUSTOM_3DPARTY_DIR}/lib/IPCLib.lib)
  INCLUDE_DIRECTORIES(${SDEXT_CUSTOM_3DPARTY_DIR}/include/IPCLib)
