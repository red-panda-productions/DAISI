...
IF(OPEN_CPP_COVERAGE)
    ...
    IF(NOT "${INCLUDE_COVERAGE}" STREQUAL "")
        STRING(REGEX REPLACE "/" "\\\\" INCLUDECOVERAGE "${CMAKE_SOURCE_DIR}/${INCLUDE_COVERAGE}.cov")
        SET(INCLUDECOVERAGE "--input_coverage=${CMAKE_SOURCE_DIR}\\${INCLUDE_COVERAGE}")
...
IF(GCOVR) #(CREATE_OPEN_CPP_COVERAGE_BAT_GITHUB BAT_NAME EXE_NAME SOURCES_DIR EXCLUDED_SOURCES EXCLUDED_LINES EXPORT_TYPE EXPORT_PATH INCLUDE_COVERAGE)
    SET(EXE_PATH "${CMAKE_BINARY_DIR}/games/${EXE_NAME}")
    SET(SPEED_DREAMS_SOURCES "drivers;interfaces;libs;main;modules;tools")
    SET(SDA_SOURCES "backend;backendUnitTests;frontend;frontendUnitTests;integrationTests;rppUtils;rppUtilsTests;unitTestUtilities;unitTestUtilitiesTests")
    GET_FILENAME_COMPONENT(FINAL_SOURCE_DIR ${SOURCES_DIR} NAME)
