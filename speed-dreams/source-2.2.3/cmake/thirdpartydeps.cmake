...
IF(OPEN_CPP_COVERAGE)
    ...
    IF(NOT "${INCLUDE_COVERAGE}" STREQUAL "")
        STRING(REGEX REPLACE "/" "\\" INCLUDECOVERAGE ${INCLUDE_COVERAGE})
        SET(INCLUDE_COVERAGE "--input_coverage=${INCLUDECOVERAGE}")
        MESSAGE(STATUS "SET INPUT COVERAGE OF ${BAT_NAME} TO ${INCLUDECOVERAGE}")
