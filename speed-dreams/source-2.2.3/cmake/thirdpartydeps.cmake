...
IF(GCOVR)
    ...
    MESSAGE(STATUS ${EXCLUDEDSOURCES})
    SET(COV_EXPORT_TYPE "--html --html-details")
    SET(COV_EXTRA_COMMANDS "bash -c \"xdg-open ${CMAKE_CURRENT_BINARY_DIR}/coverage.html &\" 2> /dev/null")
    SET(COV_OUTPUT "${CMAKE_CURRENT_BINARY_DIR}/coverage.html")
...
MACRO(CREATE_OPEN_CPP_COVERAGE_BAT_GITHUB BAT_NAME EXE_NAME SOURCES_DIR EXCLUDED_SOURCES EXCLUDED_LINES EXPORT_TYPE EXPORT_PATH INCLUDE_COVERAGE)
...
IF(GCOVR)
    ...
    FOREACH(EXCLUDED_SOURCE ${EXCLUDED_SOURCES})
        SET(EXCLUDEDSOURCES "${EXCLUDEDSOURCES}|${EXCLUDED_SOURCE}")
    ENDFOREACH(EXCLUDED_SOURCE ${EXCLUDED_SOURCES})
    ...
    FILE(GENERATE OUTPUT ${CMAKE_SOURCE_DIR}/${BAT_NAME}.sh
            CONTENT
            " ${EXE_PATH}
              gcovr --gcov-ignore-parse-errors --root=${SOURCES_DIR} --exclude=\"(.*googletest.*|.*CMakeFiles.*${EXCLUDEDSOURCES})\" --exclude-lines-by-pattern ${EXCLUDED_LINES} ${COV_EXPORT_TYPE} -o ${COV_OUTPUT}
              ${COV_EXTRA_COMMANDS}"
            FILE_PERMISSIONS OWNER_EXECUTE OWNER_WRITE OWNER_READ GROUP_EXECUTE GROUP_WRITE GROUP_READ WORLD_EXECUTE WORLD_WRITE WORLD_READ)
