...
MACRO(CHECK_LIBRARIES)
	...
	# MySQL Connector
	FIND_PACKAGE(MYSQL HINTS ${SDEXT_CUSTOM_3DPARTY_DIR})

	IF(MYSQL_FOUND)
		SET(HAVE_MYSQL 1)
		MESSAGE(STATUS "Looking for library MYSQL - found")
	ELSE(MYSQL_FOUND)
		MESSAGE(FATAL_ERROR "Looking for library MYSQL - NOT found")
	ENDIF(MYSQL_FOUND)
