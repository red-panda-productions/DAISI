...
MACRO(CHECK_LIBRARIES)
	...
	IF(WIN32)
		...
		IF(OPEN_CPP_COVERAGE)
			IF(OPTION_SD_CMAKE_FIND_LOGS)
				MESSAGE(STATUS "Looking for program OpenCppCoverage - found")
			ENDIF(OPTION_SD_CMAKE_FIND_LOGS)
		ELSE(OPEN_CPP_COVERAGE)
			MESSAGE(STATUS "Looking for program OpenCppCoverage - NOT found")
			MESSAGE(STATUS "No coverage bat files will be created")
	...
	IF(UNIX)
		...
		IF(GCOVR)
			IF(OPTION_SD_CMAKE_FIND_LOGS)
				MESSAGE(STATUS "Looking for program gcovr - found")
			ENDIF(OPTION_SD_CMAKE_FIND_LOGS)
			SET(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} --coverage -g -O0")
			SET(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} --coverage -g -O0")
			SET(CMAKE_CXX_OUTPUT_EXTENSION_REPLACE ON)
		ELSE(GCOVR)
			MESSAGE(STATUS "Looking for program gcovr - NOT found")
			MESSAGE(STATUS "No coverage sh files will be created")
		ENDIF(GCOVR)
	ENDIF(UNIX)
	...
	IF(msgpack_FOUND)
		...
		ENDIF(OPTION_SD_CMAKE_FIND_LOGS)
	ELSE(msgpack_FOUND)
		MESSAGE(STATUS "Looking for library msgpack - NOT found")
	ENDIF(msgpack_FOUND)
