/***************************************************************************
    ...
    email                : torcs@free.fr
    version              : $Id: main.cpp 6982 2020-04-27 23:49:56Z iobyte $
...
// Use new Memory Manager ...
    ...
    pApp->addOptionsHelpExplainLine("              among the .xml files in <user settings>/config/raceman (no default)");
    pApp->addOptionsHelpExplainLine("- text-only : Run the specified race without any GUI (suitable for a headless computer)");
