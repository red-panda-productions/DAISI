/***************************************************************************
    ...
    email                : torcs@free.fr
    version              : $Id: track.cpp 6752 2019-11-05 14:03:20Z beaglejoe $
...
GetTrackHeader(void *TrackHandle) {
    ...
    theTrack->SpeedLimit = GfParmGetStr(TrackHandle, TRK_SECT_HDR, TRK_ATT_AVERAGE_SPEEDLIMIT, "no average speed limit");
