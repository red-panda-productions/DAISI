...
/// @brief Stores all of the data of a texture
...
/// @brief The configuration of Interventions of the frontend
...
public:
 ...
 private:
    ...
    InterventionAction m_currentAction = 0;
    tTextureData* m_textures = nullptr;
};
